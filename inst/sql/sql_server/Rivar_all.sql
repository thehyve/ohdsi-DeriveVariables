...
( 
  select concept_id from @cdm_database_schema.CONCEPT where concept_id in (45777059,45777060,40241331,40241332,40241333,40241334,40241335,40244443,43535203,40244444,40244445,40244446,40244447,43535205,40244448,40244449,40244450,44657356,44580574,44678535,44560021,40241336,40241337)and invalid_reason is null
