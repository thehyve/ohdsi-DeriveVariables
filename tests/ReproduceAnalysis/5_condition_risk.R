...
studyPop$daysAtRiskStroke <- risk_censor$DAYS_AT_RISK
studyPop$censor <- risk_censor$CENSOR

ph.summary <- printSurvivalStatistics(studyPop$daysAtRiskStroke, studyPop$censor, studyPop$RIVA_OR_VKA_STRING)
...
studyPop$daysAtRiskAF <- risk_censor$DAYS_AT_RISK
studyPop$censor <- risk_censor$CENSOR

ph.summary <- printSurvivalStatistics(studyPop$daysAtRiskAF, studyPop$censor, studyPop$RIVA_OR_VKA_STRING)
